...
for i in range(n_iterations):
    ...
    def acquisition_function(x):
        ...
        return (
            acquisition_weight * pred_quality
    ...
    if len(evaluated_points) > 1:
        ...
        if preference == 1:  # Prefers profile1
            ...
            new_label = (
                1  # The label is always 1 for the preferred profile's difference vector
            )
...
if best_quality_hitl > best_quality_xgb:
    ...
    print(
        "The original Bayesian optimization found a wine profile with a slightly better or equal quality."
    )
...
print(
    "The HITL approach, by incorporating user preferences, can sometimes explore more promising regions of the search space, potentially leading to faster discovery of high-quality profiles."
)
